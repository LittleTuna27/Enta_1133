...
namespace Dugneon_Movers.Scripts.dice_game
{
    public class PlayerVSComputer
    {
        ...
        public void WhatThatTurnDo(Player player, ComputerProfile CPU, GameManager manager) //calling a sequence of functions based on who goes first
        {
